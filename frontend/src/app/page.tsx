  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-base-950 text-slate-100">
      ...
      <div className="relative z-10 grid h-screen min-h-screen grid-rows-[auto_minmax(0,1fr)_auto]">
        ...
        <section className="grid h-full min-h-0 grid-cols-[minmax(250px,290px)_minmax(0,1fr)_minmax(320px,380px)] gap-4 overflow-hidden px-4 pb-3 pt-4 max-[1180px]:grid-cols-[240px_minmax(0,1fr)_320px] max-[980px]:grid-cols-[220px_minmax(0,1fr)] max-[980px]:grid-rows-[1fr_auto]">
          <SidebarLeft />
          <CenterStage />
          <RightPanel />
        </section>
